...
<div class="bottomrect" >
  <div class="flexcus">
    ...
    <div class="flex-item-right overflow-auto ">
      <div class="grid grid-cols-3 gap-2 bg-black overflow-scroll overflow-x-hidden rounded-2xl">
        <div class="card flex flex-row" v-for="(animation, index) in animations" :key="index">
          ...
          <div class=" flex w-1/2 h-full bg-rose-400 relative">
            <div class="imgcard">
            <img class="imgcus" :src="animation.poster" :alt="animation.title" >
          </div>
          </div>
          <div class=" flex flex-col w-1/2 h-full bg-yellow-400 relative items-center justify-center space-y-10">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      currentAnimation: {} // Initialize currentMovie with default values
    }
    },
